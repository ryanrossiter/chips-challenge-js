...
Screen.prototype.drawRect = function(color, x, y, w, h) {
	this.bufferContext.fillStyle = color;
	this.bufferContext.fillRect(x + this.xOff, y + this.yOff, w, h);
}

Screen.prototype.drawText = function(text, x, y, color) {
	if (color != undefined) {
		this.bufferContext.fillStyle = color;
	}
...
Screen.prototype.drawSprite = function(spriteName, x, y, w, h) {
...
Screen.prototype.drawFromSpritesheet = function(sheet, spriteW, spriteH, index, x, y) {
...
Screen.prototype.drawTile = function(tileset, tileID, tileX, tileY) {
...
Screen.prototype.setOffset = function(xOffset, yOffset) {
	this.xOff = xOffset;
	this.yOff = yOffset;
}